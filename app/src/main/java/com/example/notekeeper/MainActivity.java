...
import static com.example.notekeeper.NoteKeeperProviderContract.Notes.CONTENT_EXPANDED_URI;
...
public class MainActivity extends AppCompatActivity
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (id == LOADER_NOTES) {
            ...
            loader = new CursorLoader(this, CONTENT_EXPANDED_URI, noteColumns, null, null, noteOrderBy);
